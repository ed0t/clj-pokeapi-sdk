...
(def nature-response
  {:cached nil,
   ...
   :headers {"x-cache" "MISS",
             "x-timer" "S1705406267.622965,VS0,VE406",
             "Server" "cloudflare",
             ...
             "Accept-Ranges" "bytes",
             "x-country-code" "US",
             "etag" "W/\"6cb-7v5IfGRtolwVtpLCUkL0smNRKlc\"",
             "CF-Cache-Status" "HIT",
             "CF-RAY" "849f5371cbbb0691-LHR",
             "x-cache-hits" "0",
             "Date" "Tue, 23 Jan 2024 10:24:16 GMT",
             "vary" "Accept-Encoding,cookie,need-authorization, x-fh-requested-host, accept-encoding",
             "function-execution-id" "vwf0s945pa0t",
             "x-powered-by" "Express",
             "Report-To" "{\"endpoints\":[{\"url\":\"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=UFWJfp1j5Z57IweJ0G%2F5jUIPL8oQXB3sXXb6e11pBJRKVCxz1T%2BcaBdSxg4i7km0MTerRlBUJTtJz%2BeuMfPldBlC8h3ERFMmNh%2FlGGbKH05c%2FFX7kgql3Kt06peq\"}],\"group\":\"cf-nel\",\"max_age\":604800}",
             "Cache-Control" "public, max-age=86400, s-maxage=86400",
             "x-served-by" "cache-mia-kmia1760062-MIA",
             "x-cloud-trace-context" "009e1dc6fbaca161cadef9a3139dbe28"},
   :orig-content-encoding "gzip",
   :status 200,
   :length 453,
   :body {:move_battle_style_preferences [{:high_hp_preference 61,
          ...
          :pokeathlon_stat_changes [{:max_change -1,
                                     :pokeathlon_stat {:name "speed", :url "https://pokeapi.co/api/v2/pokeathlon-stat/1/"}}
                                    {:max_change 1,
                                     :pokeathlon_stat {:name "power", :url "https://pokeapi.co/api/v2/pokeathlon-stat/2/"}}],
          :id 1,
          :hates_flavor nil,
          :names [{:language {:name "ja-Hrkt", :url "https://pokeapi.co/api/v2/language/1/"}, :name "がんばりや"}
                  {:language {:name "ko", :url "https://pokeapi.co/api/v2/language/3/"}, :name "노력"}
                  {:language {:name "zh-Hant", :url "https://pokeapi.co/api/v2/language/4/"}, :name "勤奮"}
                  {:language {:name "fr", :url "https://pokeapi.co/api/v2/language/5/"}, :name "Hardi"}
                  {:language {:name "de", :url "https://pokeapi.co/api/v2/language/6/"}, :name "Robust"}
                  {:language {:name "es", :url "https://pokeapi.co/api/v2/language/7/"}, :name "Fuerte"}
                  {:language {:name "it", :url "https://pokeapi.co/api/v2/language/8/"}, :name "Ardita"}
                  {:language {:name "en", :url "https://pokeapi.co/api/v2/language/9/"}, :name "Hardy"}
                  {:language {:name "ja", :url "https://pokeapi.co/api/v2/language/11/"}, :name "がんばりや"}
                  {:language {:name "zh-Hans", :url "https://pokeapi.co/api/v2/language/12/"}, :name "勤奋"}]},
   :trace-redirects []})
...
(def pokemon-response
  {:cached nil,
   ...
   :reason-phrase "OK",
   :headers {"x-cache" "HIT",
             "x-timer" "S1705220783.598075,VS0,VE0",
             "Server" "cloudflare",
             "Age" "41625",
             "Content-Type" "application/json; charset=utf-8",
             "access-control-allow-origin" "*",
             ...
             "Accept-Ranges" "bytes",
             "x-country-code" "US",
             "etag" "W/\"3b992-n7nvIo20z+D9ITTeRSL4j39hPGk\"",
             "CF-Cache-Status" "HIT",
             "CF-RAY" "84a072bdba310691-LHR",
             "x-cache-hits" "6",
             "Date" "Tue, 23 Jan 2024 13:40:23 GMT",
             "x-orig-accept-language" "vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5",
             "vary" "Accept-Encoding,cookie,need-authorization, x-fh-requested-host, accept-encoding",
             "function-execution-id" "vwf0yavk1z90",
             "x-powered-by" "Express",
             "Report-To" "{\"endpoints\":[{\"url\":\"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=EbSkHSgv5131jkzDa1prO%2BGX0uQg4ueJTuYAQUcXDfk6Gefy1e8MFjotuOfPohCJ3XS4rXWSBuG7XBaorFmnRDt5RmHpm1Gail83FVAf2WhxHqB6OWkjhPhliDZK\"}],\"group\":\"cf-nel\",\"max_age\":604800}",
             "Cache-Control" "public, max-age=86400, s-maxage=86400",
             "x-served-by" "cache-mia-kmia1760070-MIA",
             "x-cloud-trace-context" "ff064b3db9515a7c1a1103e1394fdae8"},
   :orig-content-encoding "gzip",
   :status 200,
   :length 6484,
   :body {:moves [{:move {:name "razor-wind", :url "https://pokeapi.co/api/v2/move/13/"},
                  ...
                  {:move {:name "vine-whip", :url "https://pokeapi.co/api/v2/move/22/"},
                   :version_group_details [{:level_learned_at 13,
                  ...
                  {:move {:name "growth", :url "https://pokeapi.co/api/v2/move/74/"},
                   :version_group_details [{:level_learned_at 34,
                                            :move_learn_method {:name "level-up",
                                                                :url "https://pokeapi.co/api/v2/move-learn-method/1/"},
                                            :version_group {:name "red-blue",
                                                            :url "https://pokeapi.co/api/v2/version-group/1/"}}
                  ...
                  {:move {:name "razor-leaf", :url "https://pokeapi.co/api/v2/move/75/"},
                   :version_group_details [{:level_learned_at 27,
                                            :move_learn_method {:name "level-up",
                                                                :url "https://pokeapi.co/api/v2/move-learn-method/1/"},
                                            :version_group {:name "red-blue",
                                                            :url "https://pokeapi.co/api/v2/version-group/1/"}}
                  ...
                  {:move {:name "solar-beam", :url "https://pokeapi.co/api/v2/move/76/"},
                   :version_group_details [{:level_learned_at 48,
                                            :move_learn_method {:name "level-up",
                                                                :url "https://pokeapi.co/api/v2/move-learn-method/1/"},
                                            :version_group {:name "red-blue",
                                                            :url "https://pokeapi.co/api/v2/version-group/1/"}}
                  ...
                  {:move {:name "sleep-powder", :url "https://pokeapi.co/api/v2/move/79/"},
                   :version_group_details [{:level_learned_at 41,
                                            :move_learn_method {:name "level-up",
                                                                :url "https://pokeapi.co/api/v2/move-learn-method/1/"},
                                            :version_group {:name "red-blue",
                                                            :url "https://pokeapi.co/api/v2/version-group/1/"}}
                  ...
                  {:move {:name "sweet-scent", :url "https://pokeapi.co/api/v2/move/230/"},
                   :version_group_details [{:level_learned_at 25,
                                            :move_learn_method {:name "level-up",
                                                                :url "https://pokeapi.co/api/v2/move-learn-method/1/"},
                                            :version_group {:name "gold-silver",
                                                            :url "https://pokeapi.co/api/v2/version-group/3/"}}
                  ...
                  {:move {:name "synthesis", :url "https://pokeapi.co/api/v2/move/235/"},
                   :version_group_details [{:level_learned_at 39,
                                            :move_learn_method {:name "level-up",
                                                                :url "https://pokeapi.co/api/v2/move-learn-method/1/"},
                                            :version_group {:name "gold-silver",
                                                            :url "https://pokeapi.co/api/v2/version-group/3/"}}
                  ...
                  {:move {:name "worry-seed", :url "https://pokeapi.co/api/v2/move/388/"},
                   :version_group_details [{:level_learned_at 31,
                                            :move_learn_method {:name "level-up",
                                                                :url "https://pokeapi.co/api/v2/move-learn-method/1/"},
                                            :version_group {:name "diamond-pearl",
                                                            :url "https://pokeapi.co/api/v2/version-group/8/"}}
          ...
          :order 1,
          :game_indices [{:game_index 153, :version {:name "red", :url "https://pokeapi.co/api/v2/version/1/"}}
          ...
          :sprites {:front_shiny_female nil,
                    :other {:dream_world {:front_default "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/1.svg",
                                          :front_female nil},
                            :home {:front_default "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/1.png",
                                   :front_female nil,
                            ...
                            :showdown {:back_default "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/showdown/back/1.gif",
                                       :back_female nil,
                    ...
                    :versions {:generation-i {:red-blue {:back_default "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-i/red-blue/back/1.png",
                               ...
                               :generation-iv {:diamond-pearl {:back_default "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-iv/diamond-pearl/back/1.png",
                                               ...
                                               :platinum {:back_default "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-iv/platinum/back/1.png",
                                                          ...
                                                          :front_shiny_female nil}},
                               :generation-v {:black-white {:front_shiny_female nil,
                                                            :back_female nil,
                                                            :animated {:back_default "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/back/1.gif",
                                                                       :back_female nil,
...
(def stats-response
  {:cached nil,
   ...
   :reason-phrase "OK",
   :headers {"x-cache" "MISS",
             "x-timer" "S1705722968.469506,VS0,VE362",
             "Server" "cloudflare",
             "Content-Type" "application/json; charset=utf-8",
             "access-control-allow-origin" "*",
             "Content-Length" "306",
             ...
             "Accept-Ranges" "bytes",
             "x-country-code" "US",
             "etag" "W/\"4f1-ZITvwbKnAO8wezcPkDsdlerDezc\"",
             "CF-Cache-Status" "REVALIDATED",
             "CF-RAY" "84a0757f0f5648ce-LHR",
             "x-cache-hits" "0",
             "Date" "Tue, 23 Jan 2024 13:42:17 GMT",
             "x-orig-accept-language" "en-US,en;q=0.9,pt;q=0.8,fr;q=0.7",
             "vary" "Accept-Encoding,cookie,need-authorization, x-fh-requested-host, accept-encoding",
             "function-execution-id" "gq2u0zyv74g3",
             "x-powered-by" "Express",
             "Report-To" "{\"endpoints\":[{\"url\":\"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=6mZ1%2BELhXLC0jFPtCyfjhY0wH1SNfobpaN0A6nfwUKnmWAOiex8Fd9cXinCv5WKUJgD%2FQllJ%2FsVSlsdlNqRNb3ib7ln1BjdeFcw5%2Blhkytg9ZkapPYTNSvnUQYPt\"}],\"group\":\"cf-nel\",\"max_age\":604800}",
             "Cache-Control" "public, max-age=86400, s-maxage=86400",
             "x-served-by" "cache-mia-kmia1760040-MIA",
             "x-cloud-trace-context" "ed11ead27c5f9d188e295b9aa634b1ee"},
   :orig-content-encoding "gzip",
   :status 200,
   :length 306,
   :body {:affecting_moves {:decrease [], :increase []},
          :move_damage_class nil,
          :name "hp",
          :is_battle_only false,
          :game_index 1,
          :id 1,
          :characteristics [{:url "https://pokeapi.co/api/v2/characteristic/1/"}
          ...
          :names [{:language {:name "ja-Hrkt", :url "https://pokeapi.co/api/v2/language/1/"}, :name "HP"}
                  {:language {:name "ko", :url "https://pokeapi.co/api/v2/language/3/"}, :name "HP"}
                  {:language {:name "zh-Hant", :url "https://pokeapi.co/api/v2/language/4/"}, :name "HP"}
                  {:language {:name "fr", :url "https://pokeapi.co/api/v2/language/5/"}, :name "PV"}
                  {:language {:name "de", :url "https://pokeapi.co/api/v2/language/6/"}, :name "KP"}
                  {:language {:name "es", :url "https://pokeapi.co/api/v2/language/7/"}, :name "PS"}
                  {:language {:name "it", :url "https://pokeapi.co/api/v2/language/8/"}, :name "PS"}
                  {:language {:name "en", :url "https://pokeapi.co/api/v2/language/9/"}, :name "HP"}
                  {:language {:name "zh-Hans", :url "https://pokeapi.co/api/v2/language/12/"}, :name "HP"}]},
   :trace-redirects []}
  )